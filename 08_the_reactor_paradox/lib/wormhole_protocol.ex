defmodule WormholeProtocol do
  ...
  Lesson 8 introduces the reactor paradox: a past shutdown can be accepted by
  the aggregate, yet replay reveals that it erases the failure that made the
  wormhole possible.
  """
  ...
  @spec reactor_paradox_story!() :: map()
  def reactor_paradox_story! do
    timeline_id = unique_timeline_id("paradox")
