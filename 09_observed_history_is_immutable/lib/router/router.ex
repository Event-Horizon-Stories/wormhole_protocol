defmodule WormholeProtocol.Router do
  ...
  dispatch(
    [
      Commands.OpenTimeline,
      Commands.RegisterSector,
      Commands.SetRealityPolicy,
      Commands.AllocateOxygen,
      Commands.RegisterReactor,
      Commands.RecordReactorFailure,
      Commands.ShutdownReactor
    ],
