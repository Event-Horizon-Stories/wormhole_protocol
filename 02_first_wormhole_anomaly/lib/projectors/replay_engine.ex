defmodule WormholeProtocol.Projectors.ReplayEngine do
  ...
  defp apply_event(%{event: %WormholeProtocol.Events.TimelineOpened{}}, sectors), do: sectors

  defp apply_event(%{event: %WormholeProtocol.Events.SectorRegistered{} = event}, sectors) do
  ...
  defp apply_event(%{event: %WormholeProtocol.Events.OxygenAllocated{} = event}, sectors) do
