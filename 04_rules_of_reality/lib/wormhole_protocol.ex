defmodule WormholeProtocol do
  ...
  Lesson 4 lets each aggregate define its rule of reality by declaring whether
  past-arriving commands must be rejected or whether history may be rewritten.
  """
  ...
  @doc """
  Compares the two reality policies the aggregate can enforce.
  """
  @spec rules_of_reality_story!() :: map()
  def rules_of_reality_story! do
    timeline_id = unique_timeline_id("rules")
    ...
    :ok = set_reality_policy(timeline_id, :rewrite_history, "10:06")
    ...
    %{
      rejected: rejected,
      rewritten: rewritten,
      reality_policy: state.reality_policy,
